...
def add_new_employee():
    ...
    number_of_working_days = input_int("  Số ngày công (1-30): ", 1, 30)
    ...
    print(f"     Tổng thu nhập: {total_income}  ->  Phân loại: {income_classification}")
    print("=" * 55)
...
def remove_employee():
    ...
    while True:
        confirm = input("  Bạn có chắc chắn muốn xóa? (Y/N): ").strip().upper()
        if confirm == 'Y':
